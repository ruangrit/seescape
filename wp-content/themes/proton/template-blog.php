	...
	<div class="blog sm-top-padding">
		<?php
			...
			if ($proton_blog_creative_opacity) {
				proton_generate_custom_css(".wrapper .blog-grid .blog-post .blog-info {background-color: rgba(211, 211, 211, ". $proton_blog_creative_opacity .")}");
			}

			// Blog Layout
			$proton_blog_layout = get_field("proton_blog_layout");
			$blog_layout = proton_get_rdx_option('blog_layout');
			$blog_pagination_position = proton_get_rdx_option('blog_pagination_position');
			...
			$proton_blog_post = "blog-post md-bottom-padding";
			...
			if($proton_blog_layout == '1'){
				$proton_blog_layout = proton_get_rdx_option('blog_layout');
			...
			switch($blog_layout){
				...
				break;
				case '3':
					$proton_blog_content = "blog-content masonry";
				...
				break;
				case '5':
					$proton_blog_content = "blog-grid blog-content masonry creative-blog";
			...
			// Sidebar Position
			$blog_sidebar = proton_get_rdx_option('blog_sidebar');
			...
			if($proton_blog_position_sidebar == '1'){
				$proton_blog_position_sidebar = proton_get_rdx_option('blog_sidebar');
			...
			if($proton_blog_pagination_position == '1'){
				$proton_blog_pagination_position = proton_get_rdx_option('blog_pagination_position');
			...
			$blog_author_info = proton_get_rdx_option("blog_author_info");
			$proton_blog_show_categories = get_field("proton_blog_show_categories");
			$blog_show_categories = proton_get_rdx_option("blog_categories");
			$proton_blog_show_post_date = get_field("proton_blog_show_post_date");
			$blog_show_post_date = proton_get_rdx_option("blog_post_date");
