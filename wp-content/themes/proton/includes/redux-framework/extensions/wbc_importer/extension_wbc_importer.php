    ...
    class ReduxFramework_extension_wbc_importer {
        ...
        function add_importer_section() {
            ...
            $this->parent->sections[] = array(
                ...
                'desc'   => '<p class="description">Works best to import on a new install of WordPress, if something does not work well, please check this <a target="_BLANK" href="http://neuronthemes.com/documentation/knowledge-base/common-php-issues/">article</a>. </p>',
...
if ( !function_exists( 'proton_extended_radium' ) ) {
    function proton_extended_radium( $demo_active_import , $demo_directory_path ) {
        reset( $demo_active_import );
        $current_key = key( $demo_active_import );

        // Assign the Homepage
        $homepage = get_page_by_title('Masonry 3 Columns');
    ...
    add_action( 'wbc_importer_after_content_import', 'proton_extended_radium', 10, 2 );
}
