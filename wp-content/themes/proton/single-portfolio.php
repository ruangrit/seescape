...
$proton_project_single_style = get_field("single_layout");
...
$proton_project_gallery_columns = get_field("gallery_columns");
    ...
    <div class="project-single md-top-padding">
        <div class="<?php echo esc_attr($proton_project_single_style_row); ?>">
                ...
                <div class="single-info">
                    <div class="project-description">
                        ...
                        <?php
							...
							// Tabs
							get_template_part('templates/single-tabs-portfolio');

							// Share
							get_template_part('templates/single-share-portfolio');
						?>
                    </div>
                </div>
            </div>
            <div class="<?php echo esc_attr($proton_project_single_style_gallery); ?>">
                <?php
                    // Embed Videos
                    $proton_project_single_embed_video = get_field("single_embed_video");
                    ...
                    if ($proton_project_single_embed_video && $portfolio_item_embed_position == '1') {
                        echo "<div class='embed-container'>" . $proton_project_single_embed_video . "</div>";
                    }

                    // Fancybox
                    $portfolio_item_gallery = proton_get_rdx_option('portfolio_item_gallery');
                    $proton_portfolio_item_gallery = get_field("single_fancybox");
                ...
                <div class="<?php echo esc_attr($project_single_gallery); ?>">
                    <?php if(have_rows("single_gallery")) : while(have_rows("single_gallery")) : the_row(); ?>
                        <div class="<?php echo esc_attr($proton_project_gallery_cols); ?>">
                            <?php
                                $proton_project_single_gallery_img = get_sub_field("single_gallery_image");
                                $proton_project_single_gallery_description = get_sub_field("single_gallery_description");
                                if($portfolio_item_gallery || $proton_portfolio_item_gallery){
                                    $project_single_image_url = $proton_project_single_gallery_img;
                                } else {
                                    $project_single_gallery = "row masonry";
                            ...
                            <a title="<?php echo $proton_project_single_gallery_description; ?>" href="<?php echo esc_attr($project_single_image_url); ?>">
                                <img src="<?php echo esc_url($proton_project_single_gallery_img); ?>" alt="">
                                <?php
