	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				...
				<td>
					<label><input onclick="jQuery('#recaptcha_type_div_robot').show();" <?php echo (!empty($recaptcha_type) && $recaptcha_type == "robot") ? 'checked="checked"' : ''; ?> type="radio" name="recaptcha_type" value="robot" id="recaptcha_type_robot" /> <?php _e("I'm not a robot", 'wp-mailinglist'); ?></label>
