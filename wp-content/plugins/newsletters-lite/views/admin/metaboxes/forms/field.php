		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<?php else : ?>
						<input type="text" class="widefat" name="form_fields[<?php echo $field -> id; ?>][placeholder]" id="form_fields_<?php echo $field -> id; ?>_placeholder" value="<?php echo esc_attr(wp_unslash(__($form_field -> placeholder))); ?>" placeholder="<?php echo esc_attr(wp_unslash(__($field -> watermark))); ?>" />
					<?php endif; ?>
