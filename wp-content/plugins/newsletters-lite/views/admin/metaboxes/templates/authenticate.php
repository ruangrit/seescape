				    	...
				    	<div id="languagetabsauthenticate">
				            ...
				            <?php foreach ($languages as $language) : ?>
				            	<div id="languagetabauthenticate<?php echo $tabnumber; ?>">
				            		<input type="text" name="etsubject_authenticate[<?php echo $language; ?>]" value="<?php echo esc_attr(wp_unslash($this -> language_use($language, $texts))); ?>" id="etsubject_authenticate_<?php echo $language; ?>" class="widefat" />
				            	</div>
				            	<?php $tabnumber++; ?>
				            <?php endforeach; ?>
				    	</div>
