	...
	$.fn.newsletters_blockeditor = function() {
		...
		var newsletters_autosave = function() {				
			...
			newsletters_autosave_request = $.ajax({
				...
				data: $formdata,
				dataType: "json",
				url: newsletters_ajaxurl + 'action=newsletters_autosave_blockeditor&security=<?php echo wp_create_nonce('newsletters_autosave_blockeditor'); ?>',
				type: "POST",
				success: function(response) {
					...
					$('#autosave').html('<?php _e('Draft saved at', 'wp-mailinglist'); ?> ' + autosavedate).show();
