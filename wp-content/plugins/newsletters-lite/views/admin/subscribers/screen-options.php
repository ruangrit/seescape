	...
	<form action="" method="post">
        ...
        <div class="metabox-prefs">
        	...
        	<?php if (!empty($saveipaddress)) : ?>
				...
				<label><input <?php echo (!empty($curcustomfields) && in_array('country', $curcustomfields)) ? 'checked="checked"' : ''; ?> type="checkbox" name="custom[]" value="country" id="custom_country" /> <?php _e('Country', 'wp-mailinglist'); ?></label>
			<?php endif; ?>
