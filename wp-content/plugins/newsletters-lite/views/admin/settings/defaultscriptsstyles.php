			...
			<?php foreach ($defaultstyles as $handle => $style) : ?>
				...
				<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
					<th class="check-column">
						<input <?php echo (!empty($loadstyles) && in_array($handle, $loadstyles)) ? 'checked="checked"' : ''; ?> type="checkbox" name="loadstyles[]" value="<?php echo esc_attr(wp_unslash($handle)); ?>" id="loadstyles_<?php echo $handle; ?>" />
					</th>
					<td>
					...
					<td>
						<input class="widefat" type="text" name="loadstyles_handles[<?php echo $handle; ?>]" value="<?php echo esc_attr(wp_unslash($custom_handle)); ?>" id="loadstyles_handles_<?php echo $handle; ?>" />
					</td>
					<td>
						<input placeholder="<?php echo esc_attr(wp_unslash(__('All posts/pages', 'wp-mailinglist'))); ?>" class="widefat" type="text" name="loadstyles_pages[<?php echo $handle; ?>]" value="<?php echo esc_attr(wp_unslash($custom_pages)); ?>" id="loadstyles_pages_<?php echo $handle; ?>" />
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
	...
	<table class="widefat">
		...
		<tbody>
			...
			<?php foreach ($defaultscripts as $handle => $script) : ?>
				...
				<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
					<th class="check-column">
						<input <?php echo (!empty($loadscripts) && in_array($handle, $loadscripts)) ? 'checked="checked"' : ''; ?> type="checkbox" name="loadscripts[]" value="<?php echo esc_attr(wp_unslash($handle)); ?>" id="loadscripts_<?php echo $handle; ?>" />
					</th>
					<td>
					...
					<td>
						<input class="widefat" type="text" name="loadscripts_handles[<?php echo $handle; ?>]" value="<?php echo esc_attr(wp_unslash($custom_handle)); ?>" id="loadscripts_handles_<?php echo $handle; ?>" />
					</td>
					<td>
						<input placeholder="<?php echo esc_attr(wp_unslash(__('All posts/pages', 'wp-mailinglist'))); ?>" class="widefat" type="text" name="loadscripts_pages[<?php echo $handle; ?>]" value="<?php echo esc_attr(wp_unslash($custom_pages)); ?>" id="loadscripts_pages_<?php echo $handle; ?>" />
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
