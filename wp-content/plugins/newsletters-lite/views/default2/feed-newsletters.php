<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
	<channel>
		...
		<lastBuildDate><![CDATA[<?php echo $Html -> gen_date(DATE_RSS, false, false, false, false); ?>]]></lastBuildDate>
		
		<?php if (!empty($emails)) : ?>
			<?php foreach ($emails as $email) : ?>
				<item>
					<title><![CDATA[<?php echo wp_unslash($email -> subject); ?>]]></title>
					<link><![CDATA[<?php echo ($Html -> retainquery('newsletters_method=newsletter&id=' . $email -> id . '&fromfeed=1', home_url())); ?>]]></link>
					<guid><![CDATA[<?php echo ($Html -> retainquery('newsletters_method=newsletter&id=' . $email -> id . '&fromfeed=1', home_url())); ?>]]></guid>
