...
<?php if (!empty($errors)) : ?>
	<div class="alert alert-danger">
		<i class="fa fa-exclamation-triangle"></i> <?php _e('Profile could not be saved, see errors below.', 'wp-mailinglist'); ?>
	</div>
<?php endif; ?>
		    ...
		    <div>
			    <div class="col-md-12">
			    	...
			    	<?php if (!empty($errors['password'])) : ?>
			    		<div class="alert alert-danger">
				    		<i class="fa fa-exclamation-triangle"></i> <?php echo $errors['password']; ?>
			    		</div>
			    	<?php endif; ?>
			    </div>
		    </div>
...
<?php else : ?>
	<div class="alert alert-danger">
		<i class="fa fa-exclamation-triangle"></i> <?php _e('No custom fields are available at this time.', 'wp-mailinglist'); ?>
	</div>
<?php endif; ?>
...
jQuery(document).ready(function() { 	
	...
	if (jQuery.isFunction(jQuery.fn.ajaxForm)) {
		jQuery('#subscribersavefieldsform').ajaxForm({
			url: newsletters_ajaxurl + "action=managementsavefields&security=<?php echo wp_create_nonce('managementsavefields'); ?>",
			type: "POST",
			cache: false,
