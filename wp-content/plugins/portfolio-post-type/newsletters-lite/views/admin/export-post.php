...
<div class="wrap newsletters <?php echo $this -> pre; ?>">
	...
	<?php if (!empty($subscribers)) : ?>
		...
		function exportmultiple(exportsubscribers) {
			...
			requestArray.push(jQuery.post(newsletters_ajaxurl + 'action=newsletters_exportmultiple&security=<?php echo wp_create_nonce('exportmultiple'); ?>', {delimiter:'<?php echo $delimiter; ?>', subscribers:exportsubscribers, headings:headings, exportfile:'<?php echo $exportfile; ?>'}, function(response) {
