...
<html xmlns="https://www.w3.org/1999/xhtml">
	<head>
		...
		function posts_changeCategory() {			
			...
			jQuery.post(newsletters_ajaxurl + "action=newsletters_posts_by_category&security=<?php echo wp_create_nonce('posts_by_category'); ?>&cat_id=" + posts_category_menu.val(), {category:posts_category_menu.val(),language:postslanguage,post_type:post_type}, function(response) {
