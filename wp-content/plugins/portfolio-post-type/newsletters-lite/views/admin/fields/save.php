							...
							<div id="tabs_watermark">
								...
								<?php foreach ($languages as $language) : ?>
									<div id="tabs_watermark_<?php echo $tabs_watermark; ?>">
										<input placeholder="<?php echo esc_attr(wp_unslash(__('Enter watermark text here', 'wp-mailinglist'))); ?>" type="text" class="widefat" name="Field[watermark][<?php echo $language; ?>]" value="<?php echo esc_attr(wp_unslash($Html -> field_value('Field[watermark]', $language))); ?>" id="Field_watermark_<?php echo $language; ?>" />
									</div>
									<?php $tabs_watermark++; ?>
								<?php endforeach; ?>
							</div>
									...
									<?php foreach ($fieldoptions as $fieldoption) : ?>
										<li id="<?php echo $fieldoption -> id; ?>" class="fieldoptions-sortable">
											...
											<span class="fieldoptions-input">
													...
													<div id="tabs_fieldoptions_<?php echo $fieldoption -> id; ?>">
														...
														<?php foreach ($languages as $language) : ?>
															<div id="tabs_fieldoptions_<?php echo $fieldoption -> id; ?>_<?php echo $language; ?>">
																<input type="hidden" name="Field[fieldoptions][<?php echo $language; ?>][<?php echo $f; ?>][id]" value="<?php echo esc_attr(wp_unslash($fieldoption -> id)); ?>" />
																<input class="widefat" type="text" name="Field[fieldoptions][<?php echo $language; ?>][<?php echo $f; ?>][value]" value="<?php echo esc_attr(wp_unslash($this -> language_use($language, $fieldoption -> value))); ?>" id="" />
															</div>
														<?php endforeach; ?>
													</div>
												...
												<?php else : ?>
													<input type="hidden" name="Field[fieldoptions][<?php echo $f; ?>][id]" value="<?php echo esc_attr(wp_unslash($fieldoption -> id)); ?>" />
													<input class="widefat" type="text" name="Field[fieldoptions][<?php echo $f; ?>][value]" value="<?php echo esc_attr(wp_unslash(__($fieldoption -> value))); ?>" id="" />
												<?php endif; ?>
											</span>
								...
								if (confirm('<?php _e('Are you sure you want to delete this option?', 'wp-mailinglist'); ?>')) {
									...
									if (id != "") {
										jQuery.ajax({
											type: "POST",
											data: {id:id},
											url: newsletters_ajaxurl + "action=newsletters_delete_option&security=<?php echo wp_create_nonce('delete_option'); ?>",
								...
								<div id="tabs_errormessage">
									...
									<?php foreach ($languages as $language) : ?>
										<div id="tabs_errormessage_<?php echo $tabs_errormessage; ?>">
											<input type="text" class="widefat" name="Field[errormessage][<?php echo $language; ?>]" value="<?php echo esc_attr(wp_unslash($this -> language_use($language, $Field -> data -> errormessage))); ?>" id="Field_errormessage_<?php echo $tabs_errormessage; ?>" />
										</div>
										<?php $tabs_errormessage++; ?>
									<?php endforeach; ?>
								</div>
								...
								<?php if (!empty($lists)) : ?>
									...
									<div id="newsletters-mailinglists-checkboxes" class="scroll-list">
										<?php foreach ($lists as $id => $title) : ?>
											...
											$fieldslist = (empty($Field -> data -> id)) ? map_deep($_POST[$Field -> model]['mailinglists'], 'sanitize_text_field') : $checkedlistsbyfield; 
											
											?>
											<label><input <?php echo (!empty($fieldslist) && is_array($fieldslist) && in_array($id, $fieldslist)) ? 'checked="checked"' : ''; ?> type="checkbox" id="checklist<?php echo $id; ?>" name="Field[mailinglists][]" value="<?php echo esc_attr($id); ?>" /> <?php echo $title; ?></label><br/>
										<?php endforeach; ?>
									</div>
									<p><a href="#" class="button" onclick="jQuery.colorbox({title:'<?php echo esc_attr(wp_unslash(__('Add a Mailing List', 'wp-mailinglist'))); ?>', href:newsletters_ajaxurl + 'action=newsletters_mailinglist_save&security=<?php echo wp_create_nonce('mailinglist_save'); ?>&fielddiv=newsletters-mailinglists-checkboxes&fieldname=Field[mailinglists]'}); return false;"><i class="fa fa-plus-circle"></i> <?php _e('Add Mailing List', 'wp-mailinglist'); ?></a></p>
