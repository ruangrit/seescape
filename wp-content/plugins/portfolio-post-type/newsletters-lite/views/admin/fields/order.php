		...
		jQuery(document).ready(function() {
			jQuery("ul#fields").sortable({
				...
				update: function(event, ui) {
					var request_fields = jQuery.post(newsletters_ajaxurl + "action=newsletters_order_fields&security=<?php echo wp_create_nonce('order_fields'); ?>", jQuery('ul#fields').sortable('serialize'), function(response) {
