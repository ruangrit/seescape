		...
		<tbody>
			...
			<?php if (!empty($subscriber -> ip_address) && !empty($saveipaddress)) : ?>
				<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
					...
					<td><?php echo $subscriber -> ip_address; ?> <span id="newsletters_subscriber_<?php echo $subscriber -> id; ?>_country"><?php echo $Html -> flag_by_country($subscriber -> country); ?></span>
