        ...
        <div class="scroll-list">	        
            ...
            <?php if ($themes = $Theme -> select()) : ?>
                ...
                <?php foreach ($themes as $theme_id => $theme_title) : ?>
                    <div><label><input <?php echo ((!empty($_POST['theme_id']) && $_POST['theme_id'] == $theme_id) || (empty($_POST['theme_id']) && $_POST['theme_id'] != "0" && $theme_id == $default_theme_id)) ? 'checked="checked"' : ''; ?> type="radio" name="theme_id" value="<?php echo esc_attr($theme_id); ?>" id="theme<?php echo $theme_id; ?>" /> <?php echo __($theme_title); ?></label> 
