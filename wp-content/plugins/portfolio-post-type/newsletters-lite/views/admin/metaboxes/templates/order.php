				    	...
				    	<div id="languagetabsorder">
				            ...
				            <?php foreach ($languages as $language) : ?>
				            	<div id="languagetaborder<?php echo $tabnumber; ?>">
				            		<input type="text" name="etsubject_order[<?php echo $language; ?>]" value="<?php echo esc_attr(wp_unslash($this -> language_use($language, $texts))); ?>" id="etsubject_order_<?php echo $language; ?>" class="widefat" />
				            	</div>
				            	<?php $tabnumber++; ?>
				            <?php endforeach; ?>
				    	</div>
