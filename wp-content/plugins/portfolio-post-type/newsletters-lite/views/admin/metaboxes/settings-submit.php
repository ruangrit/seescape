	...
	<div id="minor-publishing">
		...
		<div id="misc-publishing-actions">
			...
			<div class="misc-pub-section misc-pub-section-last">
				...
				<p>
					<a target="_blank" href="<?php echo esc_attr(wp_unslash(plugins_url() . '/' . $this -> plugin_name . '/' . basename(NEWSLETTERS_LOG_FILE))); ?>"><?php _e('View the log file', 'wp-mailinglist'); ?></a>
