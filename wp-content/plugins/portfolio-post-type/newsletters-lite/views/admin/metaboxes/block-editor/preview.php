...
<p>
	<a href="<?php echo $src; ?>" id="newwindowbutton" <?php if (empty($newsletters_history_id)) : ?>disabled="disabled"<?php endif; ?> target="_blank" class="button button-secondary"><i class="fa fa-external-link"></i> <?php _e('Open in New Window', 'wp-mailinglist'); ?></a>
	<button type="button" value="1" href="" id="preview_button" class="button button-primary">
		<i class="fa fa-eye"></i> <?php _e('Update Preview', 'wp-mailinglist'); ?>
...
var history_id = "<?php echo $newsletters_history_id; ?>";
<?php else : ?>
