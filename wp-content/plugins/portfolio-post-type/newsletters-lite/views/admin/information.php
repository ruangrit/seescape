...
<style type="text/css">
	*, html, body, div, dl, dt, dd, ul, ol, li, h1, h2, h3, h4, h5, h6, pre, form, label, fieldset, input, p, blockquote, th, td{margin:0;padding:0}
	...
	#tribulant_logo { background:url('<?php echo $this -> render_url('images/changelog-logo.png', 'admin', false); ?>') no-repeat; text-indent:-9999px; width:251px; height:59px; position:absolute; top:23px; }
