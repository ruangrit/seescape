 ...
 * Uses the JsonMapper to convert the response to a convenient object.
 *
...
class WINP_Request {
	...
	public function __construct() {
		require_once WINP_PLUGIN_DIR . '/includes/jsonmapper/JsonMapper.php';
		require_once WINP_PLUGIN_DIR . '/includes/jsonmapper/JsonMapper/Exception.php';
	}
